...
def create_v11_fix_nodes():
    group_name = "VoronoiCity_V11_Fix"
    ...
    # Robust Linker that handles Name (str) OR Index (int)
    ...
    link_safe(n_mat_bldg.outputs[0], n_join, "Geometry")
    
    link_safe(n_join.outputs[0], n_out, "Geometry")
    
    return ng

def setup_scene_v11_fix():
    print("=" * 40)
    print("Creating V11 Fixed...")

...
def create_scene_v9():
    print("=" * 40)
    print("RESETTING SCENE + Creating V9 (Roads + Buildings)...")
...
def create_scene_v9():
    ng = create_scene_v9() if 'create_scene_v9' in locals() else None # Recursive safety check removed

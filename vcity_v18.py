...
def create_v18_nodes():
    group_name = "VoronoiCity_V18"
    ...
    # --- STORE ATTRIBUTE FOR MATERIAL INDEX ---
    ...
    n_rand_idx.inputs['Max'].default_value = 5 # Used to be 4, max is exclusive usually. 1,2,3,4.
    
    # Use Position as ID for robustness
    ...
    n_mat_road.inputs["Material Index"].default_value = 0 # Road is 0
...
def setup_scene_v18():
    print("=" * 40)
    print("Creating V18 (Store/Read Attribute)...")
    ...
    mesh = bpy.data.meshes.new("CityV18Mesh")
    obj = bpy.data.objects.new("CityV18", mesh)
    ...
    mod = obj.modifiers.new("CityGenV18", 'NODES')
    mod.node_group = ng

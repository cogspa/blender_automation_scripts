...
def create_v22_nodes():
    group_name = "VoronoiCity_V22"
    ...
    n_read.inputs['Name'].default_value = "MatID"
...
def setup_scene_v22():
    print("=" * 40)
    print("Creating V22 (User Logic - Refined Indexing)...")
    ...
    mesh = bpy.data.meshes.new("CityV22Mesh")
    obj = bpy.data.objects.new("CityV22", mesh)
    ...
    mod = obj.modifiers.new("CityGenV22", 'NODES')
    mod.node_group = ng
